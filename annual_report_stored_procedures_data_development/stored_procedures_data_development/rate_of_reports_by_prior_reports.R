...
# sqlDrop(con_test_annie, sqtable = "rate_referrals_order_specific_ts")
sqlSave(con_test_annie, dat = dat2, tablename = "rate_referrals_order_specific_ts", rownames = FALSE)	